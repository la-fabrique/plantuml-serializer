...
import { isC4Boundary, isC4Component, isC4Container, isC4Person, isC4Relationship, isC4System, } from './guards';
function serializeElement(element, indent = 0) {
    ...
    if (isC4Boundary(element)) {
        ...
        lines.push(indentString(`${elementName}(${alias}${from}${to}${label}${technology}${description}${tags}${link})`, indent));
    }
    return lines;
}
