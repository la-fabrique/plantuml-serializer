import { C4_WORKSPACE_INCLUDE_CONTEXT, C4System } from '@/types';
export default {
    ...
    elements: [
        ...
        new C4System('SystemQueue_Ext', 'systemQueueExtAlias', 'Label', 'Optional Description', undefined, undefined, 'https://github.com/plantuml-stdlib/C4-PlantUML'),
    ],
};
