import { C4Person, C4System, C4_WORKSPACE_INCLUDE_CONTEXT, C4Relationship, } from '@/types';
export default {
    ...
    elements: [
        ...
        new C4Relationship('Rel', 'personAlias2', 'personAlias3', 'informs', 'courier', 'Optional Description'),
